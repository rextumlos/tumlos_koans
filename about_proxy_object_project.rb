...
class Proxy
  ...
  def method_missing(method_name, *args, &block)
    if @object.respond_to? method_name    # check if there's a method from the object
      @messages.push(method_name)         # storing the method name
      @object.send(method_name, *args)    # sending message to the object class
    else
